...
<div className="row" style={{marginTop:"20px",marginLeft:"20px"}}>
  ...
  >
  {Math.trunc(ChillerTotalCoolingEnergyDay + ChillerTotalCoolingEnergyDayPhase1)} TR
  </div>
</div>
...
<div
      ...
      >
        ...
        <div style={{ textAlign: "center",textAlign: "center",marginLeft:"70%",marginTop:"5%"}}><b>Loading Percentage <CircleIcon style={{color:"#ff7338",fontSize:'20px'}}/> </b></div>
</div>
</Grid>
